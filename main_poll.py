...
with open(csvpath, newline="") as csvfile:
    ...
    vote_file.writelines("Election Results " +  "\n") 
    vote_file.writelines(f"----------------------------------------" + "\n")
    vote_file.writelines(f"Total Votes:{total_votes}" + "\n")
    vote_file.writelines(f"Khan: {khan_pct} ({candidate_vote_khan})" +  "\n")
    vote_file.writelines(f"Correy: {correy_pct} ({candidate_vote_correy})"  + "\n")
    vote_file.writelines(f"Li: {li_pct}  ({candidate_vote_li})" + "\n")
    vote_file.writelines(f"O'Tooley: {otooley_pct} ({candidate_vote_otooley})" +  "\n") 
    vote_file.writelines(f"----------------------------------------" + "\n")
    vote_file.writelines(f"W I N N E R     {winner}")